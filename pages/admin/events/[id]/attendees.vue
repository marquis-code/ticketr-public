  ...
  <div class="min-h-screen   flex flex-col">
    ...
    <header class="glass-card border-b border-gray-200 px-4 md:px-6 py-4">
      <div class="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
        <NuxtLink to="/admin/events" class="text-xs font-semibold text-gray-600 hover:text-gray-900 transition">
          ← Back to Events
        </NuxtLink>
        <span class="text-xs font-bold text-primary">Attendee Gate Roster</span>
      </div>
    </header>
