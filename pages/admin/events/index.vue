      ...
      <div class="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div class="flex flex-col md:flex-row md:items-center gap-4 md:gap-6 w-full md:w-auto">
          ...
          <nav class="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-2 md:pb-0 scrollbar-hide text-xs font-semibold">
            <NuxtLink to="/admin/dashboard" class="text-gray-600 hover:text-gray-900 px-3 py-1.5 rounded-lg transition">Dashboard</NuxtLink>
            <NuxtLink to="/admin/events" class="bg-primary text-white px-3 py-1.5 rounded-lg transition">Events Management</NuxtLink>
        ...
        <NuxtLink to="/admin/events/create" class="btn-primary text-xs !py-2 !px-3.5">
          + Create Event
        </NuxtLink>
      </div>
    </header>
