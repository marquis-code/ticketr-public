<template>
  <div class="fixed inset-0 bg-gray-50 flex items-center justify-center p-6 z-50">
    <div class="w-full max-w-md bg-white border border-gray-200 rounded-xl p-8 shadow-xl">
